...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  ...
  if(ayar.jailLogKanali && client.channels.has(ayar.jailLogKanali)) client.channels.get(ayar.jailLogKanali).send(embed.setDescription(`${uye} üyesi, ${message.author} tarafından jailden çıkarıldı!`)).catch();
};
