...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  ...
  let enAltYetkiliRolu = message.guild.roles.get(ayar.enAltYetkiliRolu);
  let members = message.guild.members.filter(member => member.roles.highest.position >= enAltYetkiliRolu.position);
