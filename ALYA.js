...
client.emoji = function(x) {
  return client.emojis.get(client.emojiler[x]);
};
...
client.on("message", (message) => {
      ...
      if (commands.has(command)) {
        ...
        if (message.member.roles.has(ayar.jailRolu) || (ayar.teyitsizRolleri && ayar.teyitsizRolleri.some(rol => message.member.roles.has(rol)))) return;
